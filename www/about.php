...
<div id="contents">
  ...
  <ol>
    <li><strong>Duplication</strong> - by putting their work into different places, different maps, we're duplicating effort and not benefiting from each other's work. For example, it's common to find several different people all trying to map food growing spaces in the same part of town. Why not share?</li>
  ...
  <p>OpenEcoMaps takes the data from <a href="http://www.openstreetmap.org">OpenStreetMap</a> (published under the <a href="http://creativecommons.org/licenses/by-sa/2.0/">Creative Commons Attribution-Sharealike 2.0 license</a>), a community that is mapping the whole world and providing all of the information as <a href="http://www.opendefinition.org/okd/">open data</a>. It takes a fresh data extract every hour and turns it into reusable KML Files, which can easily be displayed on a map.</p>
